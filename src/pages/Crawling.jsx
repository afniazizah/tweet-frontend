...
const Crawling = ({ socket }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!socket.connected) {
            alert(
                "Server tidak terhubung. Silakan hidupkan server terlebih dahulu."
            );
            return;
        }
        if (inputMethod == "manual") {
            ...
            try {
                ...
                if (response.status === 422) {
                    ...
                    dispatch(startProcess([data.filename, language]));
            ...
            <div className="p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    {errorForm.startDate ? (
                                        ...
                                        <p className="text-xs text-gray-600 mt-2">
                                            Jika tanggal tidak diisi, sistem
                                            akan mengambil data terbaru
                                        </p>
                                    )}
                                </div>
                                <div>
                    ...
                    <button
                        type="submit"
                        disabled={
                            analisisData.process || processCrawling.status
                        }
                ...
                {isDoneCrawling && inputMethod === "manual" && (
                    <>
                        ...
                        <div className="mt-4 flex gap-4">
                            ...
                            <button
                                disabled={
                                    analisisData.process || totalTweet < 100
                                }
                                onClick={() => {
                                    dispatch(startProcess([fileResult, language]));
                                    dispatch(
                                        addAdditionalData({
                                            keyword: keyword,
                                            date: startDate
                        ...
                        <div className="mt-3 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                            <p className="text-sm text-yellow-800">
                                ...
                                Setelah melanjutkan analisis, file tidak dapat
                                diunduh lagi. Pastikan untuk mengunduh file
